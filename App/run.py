...
def index():
    ...
    bottom_category_count = df.iloc[:,4:].sum().sort_values(ascending=True)[1:6]
    bottom_category_names = list(bottom_category_count.index)
    # create visuals
    ...
    graphs = [
        ...
        
        {
            'data': [
                Bar(
                    x=bottom_category_names,
                    y=bottom_category_count
                )
            ],

            'layout': {
                'title': 'Bottom Five Categories',
                'yaxis': {
                    'title': "Count"
                },
                'xaxis': {
